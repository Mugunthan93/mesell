...
**Domain:** infra
**Last updated:** 2026-06-11 (mfe-cutover SP07 infra group IN REVIEW — CSP mechanism (D42) + dev smoke + staging/prod gating + D13 hosting work-package + cost sheet; cluster unreachable → offline-validated, server dry-run deferred per playbook §15)
