...
| image-precheck (precheck_smoke) | `develop` (flat-lane founder gate) | 2026-06-11 | [#122](https://github.com/Mugunthan93/mesell/pull/122) | F5 D2 Gate 2. `tests/eval/precheck_smoke/` 20-image deterministic Pillow smoke (10 bad / 10 good). Gate PASS: 22/22, worst 0.028s vs 2s, 0 Gemini ₹0. G2 ruled keep-as-built 5×5/235 (plan amended). G3 ruled fix_hints=FE static map. FLAT-LANE founder-gate PR (avoids frozen #118). |
