...
|---|-------------------|--------|------------|------------------------|-------------------|------------------|
| A | `SUB_PLAN_01_export_extraction.md` | `export` | **S** | None — first extraction | meesell-backend-coordinator (orchestrator) + meesell-services-builder (extracts service.py + tasks.py) + meesell-infra-builder (K3s manifest) | 3-5 days |
