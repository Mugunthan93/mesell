// features/catalog-form/primitives/number/number.component.ts
// Primitive 3: numeric input per §18.E
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => NumberPrimitiveComponent),
      multi: true,
    },
  ],
  template: `
...
export class NumberPrimitiveComponent implements ControlValueAccessor {
