...
def resolve(message_id: str, locale: str = "en") -> str:
    ...
    # picks up the seed/registry gap, and WARN loudly: a verbatim return is now
    # always a genuine seed/registry gap (the L_iam_1 2-segment auth-id deferral
    # allowlist was removed once ``core/auth.py`` migrated to 3-segment ids).
