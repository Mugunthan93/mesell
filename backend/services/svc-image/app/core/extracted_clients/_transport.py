...
_bearer_token: ContextVar[str | None] = ContextVar("svc_image_bearer_token", default=None)
_request_id: ContextVar[str | None] = ContextVar("svc_image_request_id", default=None)
