...
The export repository calls :func:`scope_to_user` against the vendored
``Export`` ORM entity — ``exports.user_id`` is the tenancy column.  The
``scope_to_user`` call is the §19 grep-anchor proving the tenancy invariant.
"""
