"""svc-catalog test fixtures — env bootstrap + shim context reset.
...
The 5 outbound shim tests mock the httpx transport (no live callee), so
DATABASE_URL / VALKEY_URL never reach a live service for those.  catalog runs at
MS-5 with REAL sibling pods, so CATEGORY_SVC_BASE_URL / CUSTOMER_SVC_BASE_URL
point at the sibling ClusterIPs (mocked in unit tests).
"""
...
os.environ.setdefault("JWT_SECRET", "test-jwt-secret-svc-catalog")
os.environ.setdefault("GEMINI_API_KEY", "test-gemini-key")
os.environ.setdefault("LANGFUSE_PUBLIC_KEY", "test-lf-pub")
os.environ.setdefault("LANGFUSE_SECRET_KEY", "test-lf-sec")
os.environ.setdefault("AUDIT_PII_SALT", "test-audit-pii-salt")
os.environ.setdefault("CATEGORY_SVC_BASE_URL", "http://category-svc:8001")
os.environ.setdefault("CUSTOMER_SVC_BASE_URL", "http://customer-svc:8001")
