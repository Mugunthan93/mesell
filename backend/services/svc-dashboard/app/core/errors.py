...
Owns ``MeesellError`` (the root every dashboard exception subclasses), the
locked envelope shape, and ``register_error_handlers(app)``.  The i18n resolver
is wired to the vendored ``app.i18n.resolver`` subset.
