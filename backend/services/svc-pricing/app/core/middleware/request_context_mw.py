...
category) can forward the caller's user JWT (``Authorization`` bearer) +
...
This is svc-pricing-specific (the monolith has no such middleware — its
pricing module called the callees in-process with no header forwarding
