...
**Effort status:** Waves 0,1,3 COMPLETE; Wave 2 SKIPPED (D1); Wave 1.5 BLOCKED on rate-card source. The ONLY founder actions left: merge PR #245, and choose the Wave-1.5 commission path (A or B).
